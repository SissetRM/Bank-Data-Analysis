...
It demonstrates practical skills in data cleaning, transformation, exploratory analysis, and dashboard building using Excel, Python, SQL, and Tableau.
...
This is a complete end-to-end data pipeline project with real-world constraints.
...
Perform data cleaning (removal of duplicates, invalid values, and normalisation).

Create analytical fields such as category, subcategory, month, and vendor.

Produce exploratory visualisations to detect spending patterns.

Build an interactive dashboard in Tableau/Excel for the final presentation.
...
Used a lookup table to convert Japanese column headers into English automatically.
Example mapping:
...
Visa represented the majority of the total spend.

Amex had fewer transactions but a higher average per-transaction cost.
...
I've included screenshots in the folder, and the dashboard link is below.

https://public.tableau.com/app/profile/alexander.sainsbury/vizzes
